(function () {
    ...
    var options = {
        ...
        colors: ["var(--primary-color)", "#f46ef4", "#fab632", "#fa4b42"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['var(--primary-color)', '#f46ef4', '#fab632', '#28c8eb', '#fa4b42', '#85cc41', '#be2aed'];
    ...
    var options = {
        ...
        colors: ['var(--primary-color)', '#f46ef4', '#fab632', '#28c8eb', '#fa4b42', '#85cc41', '#be2aed', '#ff8100'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
