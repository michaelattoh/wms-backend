...
(function () {
    ...
    option = {
        ...
        color: ["rgb(121, 97, 245)", "rgb(244, 110, 244)", "rgb(255, 93, 159)", "rgb(255, 93, 159)", "rgb(250, 75, 66)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(121, 97, 245)", "rgb(244, 110, 244)", "rgb(255, 93, 159)", "rgb(250, 75, 66)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(121, 97, 245)", "rgb(244, 110, 244)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(121, 97, 245)", "rgb(244, 110, 244)", "rgb(255, 93, 159)", "rgb(250, 75, 66)", "rgb(255, 93, 159)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(255, 93, 159)", "rgb(250, 75, 66)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
        ...
        series: [
            {
                ...
                itemStyle: {
                    normal: {
                        color: "rgb(121, 97, 245)",
                        color0: "rgb(244, 110, 244)",
                        borderColor: "rgb(121, 97, 245)",
                        borderColor0: "rgb(244, 110, 244)",
                    }
                }
            }
        ]
